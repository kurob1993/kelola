...
'filament.admin.pages.dashboard','filament.admin.resources.bloks.index','filament.admin.resources.bloks.create','filament.admin.resources.bloks.edit','filament.admin.resources.gangs.index',
'filament.admin.resources.gangs.create','filament.admin.resources.gangs.edit','filament.admin.resources.iurans.index','filament.admin.resources.iurans.create','filament.admin.resources.iurans.edit',
'filament.admin.resources.penguruses.index','filament.admin.resources.penguruses.create','filament.admin.resources.penguruses.edit','filament.admin.resources.perumahans.index','filament.admin.resources.perumahans.create',
'filament.admin.resources.perumahans.edit','filament.admin.resources.transaksi-iurans.index','filament.admin.resources.transaksi-iurans.create','filament.admin.resources.transaksi-iurans.edit','filament.admin.resources.transaksi-pengeluarans.index',
'filament.admin.resources.transaksi-pengeluarans.create','filament.admin.resources.transaksi-pengeluarans.edit','filament.admin.resources.users.index','filament.admin.resources.users.create','filament.admin.resources.users.edit',
'filament.admin.resources.wargas.index','filament.admin.resources.wargas.create','filament.admin.resources.wargas.edit','filament.admin.resources.shield.roles.index','filament.admin.resources.shield.roles.create',
'filament.admin.resources.shield.roles.view','filament.admin.resources.shield.roles.edit','livewire.update',
'livewire.upload-file','livewire.preview-file','storage.local',);
        registerArgumentsSet('views', 
'components.master.blok.blok-detail','components.transaksi.iuran.modal-bukti-bayar','custom.title-topbar','filament-panels::components.user-menu','forms.components.item',
'vendor.filament-panels.components.user-menu','welcome','filament-actions::badge-action','filament-actions::badge-group','filament-actions::button-action',
...
'pagination::tailwind','table-layout-toggle::layout-view-persister','table-layout-toggle::toggle-action',);
