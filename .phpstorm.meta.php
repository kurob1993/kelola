...
'blade-icons.attributes','blade-icons.fallback','blade-icons.components.disabled','blade-icons.components.default','cache.default',
...
'debugbar.theme','debugbar.debug_backtrace_limit','filament.broadcasting','filament.default_filesystem_disk','filament.assets_path',
'filament.cache_path','filament.livewire_loading_delay','filament-shield.shield_resource.should_register_navigation','filament-shield.shield_resource.slug','filament-shield.shield_resource.navigation_sort',
'filament-shield.shield_resource.navigation_badge','filament-shield.shield_resource.navigation_group','filament-shield.shield_resource.nav.group','filament-shield.shield_resource.is_globally_searchable','filament-shield.shield_resource.show_model_path',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./Users/kurob/code/iuran/public/storage','livewire.class_namespace','livewire.view_path',
...
'table-layout-toggle.persist.persiter','table-layout-toggle.persist.cache.store','table-layout-toggle.persist.cache.time','table-layout-toggle.persist.share_between_pages','ide-helper.filename',
...
'filament.admin.auth.password-reset.reset','filament.admin.auth.logout','filament.admin.auth.profile','filament.admin.auth.email-verification.prompt','filament.admin.auth.email-verification.verify',
'filament.admin.pages.dashboard','filament.admin.pages.dashboard-pengeluaran','filament.admin.resources.bloks.index','filament.admin.resources.bloks.create','filament.admin.resources.bloks.edit',
'filament.admin.resources.gangs.index','filament.admin.resources.gangs.create','filament.admin.resources.gangs.edit','filament.admin.resources.iurans.index','filament.admin.resources.iurans.create',
'filament.admin.resources.iurans.edit','filament.admin.resources.penguruses.index','filament.admin.resources.penguruses.create','filament.admin.resources.penguruses.edit','filament.admin.resources.perumahans.index',
'filament.admin.resources.perumahans.create','filament.admin.resources.perumahans.edit','filament.admin.resources.transaksi-iurans.index','filament.admin.resources.transaksi-iurans.create','filament.admin.resources.transaksi-iurans.edit',
'filament.admin.resources.transaksi-pengeluarans.index','filament.admin.resources.transaksi-pengeluarans.create','filament.admin.resources.transaksi-pengeluarans.edit','filament.admin.resources.users.index','filament.admin.resources.users.create',
'filament.admin.resources.users.edit','filament.admin.resources.wargas.index','filament.admin.resources.wargas.create','filament.admin.resources.wargas.edit','filament.admin.resources.shield.roles.index',
'filament.admin.resources.shield.roles.create','filament.admin.resources.shield.roles.view','filament.admin.resources.shield.roles.edit','livewire.update','livewire.upload-file','livewire.preview-file',
'storage.local',);
        registerArgumentsSet('views', 
'components.master.blok.blok-detail','components.transaksi.iuran.modal-bukti-bayar','custom.title-topbar','filament-panels::components.user-menu','filament.pages.dashboard-pengeluaran',
'forms.components.item','vendor.filament-panels.components.user-menu','welcome','filament-actions::badge-action','filament-actions::badge-group',
...
'pagination::simple-tailwind','pagination::tailwind','table-layout-toggle::layout-view-persister','table-layout-toggle::toggle-action',);
