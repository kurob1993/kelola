...
'database.redis.cache.database','filament.broadcasting','filament.default_filesystem_disk','filament.assets_path','filament.cache_path',
'filament.livewire_loading_delay','filament-shield.shield_resource.should_register_navigation','filament-shield.shield_resource.slug','filament-shield.shield_resource.navigation_sort','filament-shield.shield_resource.navigation_badge',
'filament-shield.shield_resource.navigation_group','filament-shield.shield_resource.nav.group','filament-shield.shield_resource.is_globally_searchable','filament-shield.shield_resource.show_model_path','filament-shield.shield_resource.is_scoped_to_tenant',
...
'filesystems.disks.s3.throw','filesystems.links./Users/kurob/code/iuran/public/storage','livewire.class_namespace','livewire.view_path','livewire.layout',
...
'filament.admin.resources.perumahans.edit','filament.admin.resources.transaksi-iurans.index','filament.admin.resources.transaksi-iurans.create','filament.admin.resources.transaksi-iurans.edit','filament.admin.resources.users.index',
...
'filament.admin.resources.shield.roles.index','filament.admin.resources.shield.roles.create','filament.admin.resources.shield.roles.view','filament.admin.resources.shield.roles.edit','livewire.update','livewire.upload-file','livewire.preview-file','storage.local',);
