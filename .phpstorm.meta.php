...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filament-shield.shield_resource.nav.group' => 'string',
            ...
            'filesystems.links./Users/kurob/code/iuran/public/storage' => 'string',
            ...
            'services.whatsapp.base_url' => 'string',
            'services.whatsapp.api_key' => 'string',
            'services.whatsapp.api_secret' => 'string',
            ...
            'table-layout-toggle.default_layout' => 'string',
            'table-layout-toggle.toggle_action.enabled' => 'boolean',
            'table-layout-toggle.toggle_action.position' => 'string',
            'table-layout-toggle.toggle_action.list_icon' => 'string',
            'table-layout-toggle.toggle_action.grid_icon' => 'string',
            'table-layout-toggle.persist.persiter' => 'string',
            'table-layout-toggle.persist.cache.store' => 'NULL',
            'table-layout-toggle.persist.cache.time' => 'integer',
            'table-layout-toggle.persist.share_between_pages' => 'boolean',
...
'app.aliases.Vite','app.force_https','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'blade-icons.sets.default.path','blade-icons.sets.default.disk','blade-icons.sets.default.prefix','blade-icons.sets.default.fallback','blade-icons.sets.default.class',
'blade-icons.sets.default.attributes','blade-icons.class','blade-icons.attributes','blade-icons.fallback','blade-icons.components.disabled',
...
'debugbar.route_middleware','debugbar.route_domain','debugbar.theme','debugbar.debug_backtrace_limit','filament.broadcasting',
'filament.default_filesystem_disk','filament.assets_path','filament.cache_path','filament.livewire_loading_delay','filament-shield.shield_resource.should_register_navigation',
'filament-shield.shield_resource.slug','filament-shield.shield_resource.navigation_sort','filament-shield.shield_resource.navigation_badge','filament-shield.shield_resource.navigation_group','filament-shield.shield_resource.nav.group',
'filament-shield.shield_resource.is_globally_searchable','filament-shield.shield_resource.show_model_path','filament-shield.shield_resource.is_scoped_to_tenant','filament-shield.shield_resource.cluster','filament-shield.tenant_model',
'filament-shield.auth_provider_model.fqcn','filament-shield.super_admin.enabled','filament-shield.super_admin.name','filament-shield.super_admin.define_via_gate','filament-shield.super_admin.intercept_gate',
'filament-shield.panel_user.enabled','filament-shield.panel_user.name','filament-shield.permission_prefixes.resource','filament-shield.permission_prefixes.page','filament-shield.permission_prefixes.widget',
'filament-shield.entities.pages','filament-shield.entities.widgets','filament-shield.entities.resources','filament-shield.entities.custom_permissions','filament-shield.generator.option',
'filament-shield.generator.policy_directory','filament-shield.generator.policy_namespace','filament-shield.exclude.enabled','filament-shield.exclude.pages','filament-shield.exclude.widgets',
'filament-shield.exclude.resources','filament-shield.discovery.discover_all_resources','filament-shield.discovery.discover_all_widgets','filament-shield.discovery.discover_all_pages','filament-shield.register_role_policy.enabled',
...
'filesystems.disks.s3.url','filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./Users/kurob/code/iuran/public/storage',
...
'services.whatsapp.base_url','services.whatsapp.api_key','services.whatsapp.api_secret','session.driver','session.lifetime',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','hashing.driver','hashing.bcrypt.rounds','hashing.bcrypt.verify',
...
'table-layout-toggle.default_layout','table-layout-toggle.toggle_action.enabled','table-layout-toggle.toggle_action.position','table-layout-toggle.toggle_action.list_icon','table-layout-toggle.toggle_action.grid_icon',
'table-layout-toggle.persist.persiter','table-layout-toggle.persist.cache.store','table-layout-toggle.persist.cache.time','table-layout-toggle.persist.share_between_pages','octane.server',
...
'octane.max_execution_time','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'filament.admin.auth.password-reset.request','filament.admin.auth.password-reset.reset','filament.admin.auth.logout','filament.admin.auth.profile','filament.admin.auth.email-verification.prompt',
'filament.admin.auth.email-verification.verify','filament.admin.pages.dashboard','filament.admin.pages.dashboard-pengeluaran','filament.admin.resources.bloks.index','filament.admin.resources.bloks.create',
'filament.admin.resources.bloks.edit','filament.admin.resources.gangs.index','filament.admin.resources.gangs.create','filament.admin.resources.gangs.edit','filament.admin.resources.iurans.index',
'filament.admin.resources.iurans.create','filament.admin.resources.iurans.edit','filament.admin.resources.penguruses.index','filament.admin.resources.penguruses.create','filament.admin.resources.penguruses.edit',
'filament.admin.resources.perumahans.index','filament.admin.resources.perumahans.create','filament.admin.resources.perumahans.edit','filament.admin.resources.transaksi-iurans.index','filament.admin.resources.transaksi-iurans.create',
'filament.admin.resources.transaksi-iurans.edit','filament.admin.resources.transaksi-pengeluarans.index','filament.admin.resources.transaksi-pengeluarans.create','filament.admin.resources.transaksi-pengeluarans.edit','filament.admin.resources.users.index',
'filament.admin.resources.users.create','filament.admin.resources.users.edit','filament.admin.resources.wargas.index','filament.admin.resources.wargas.create','filament.admin.resources.wargas.edit',
'filament.admin.resources.shield.roles.index','filament.admin.resources.shield.roles.create','filament.admin.resources.shield.roles.view','filament.admin.resources.shield.roles.edit','sanctum.csrf-cookie','telescope','livewire.update','livewire.upload-file','livewire.preview-file',
'storage.local',);
        registerArgumentsSet('views', 
'components.master.blok.blok-detail','components.transaksi.iuran.modal-bukti-bayar','custom.title-topbar','errors.minimal','filament-panels::components.user-menu',
'filament.pages.dashboard-pengeluaran','forms.components.item','vendor.filament-panels.components.user-menu','welcome','filament-actions::badge-action',
...
'pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','table-layout-toggle::layout-view-persister','table-layout-toggle::toggle-action',
'telescope::layout',);
...
'validation.uuid','validation.custom.attribute-name.rule-name','kelola.all','kelola.nav.transaction','filament-shield.0',
...
'filament-tables::table.sorting.fields.direction.options.asc','filament-tables::table.sorting.fields.direction.options.desc','table-layout-toggle::table-layout-toggle.0','filament-password-input::password.actions.copy.tooltip','filament-password-input::password.actions.regenerate.tooltip',
...
'VITE_APP_NAME','ASSET_URL','WWWUSER','WWWGROUP','TRUSTED_PROXIES',
'TRUSTED_HEADER_NAMES','WHATSAPP_BASE_URL','WHATSAPP_API_KEY','WHATSAPP_API_SECRET',);
